...
//	) );
	...
	register_post_type('downloads', array(
		'labels'             => array(
			'name'               => __('Downloads', 'bs-diona'), // Основное название типа записи
			'singular_name'      => __('Downloads', 'bs-diona'), // отдельное название записи типа Book
			'add_new'            => __('Add new', 'bs-diona'),
			'add_new_item'       => __('Add new', 'bs-diona'),
			'edit_item'          => __('Edit new', 'bs-diona'),
			'new_item'           => __('New item', 'bs-diona'),
			...
			'not_found_in_trash' => 'В корзине книг не найдено',
			'parent_item_colon'  => '',
			'menu_name'          => __('Downloads', 'bs-diona')
